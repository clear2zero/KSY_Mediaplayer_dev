...
import com.ksy.media.demo.ui.IndicatorFragment.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mTotal != 0) {
			...
			Log.i("guoli", "mCurrentScroll : " + mCurrentScroll + ",tabID :" + tabID + ", width:" + getWidth() + ",Margin" + mViewPager.getPageMargin() + ",scroll_x:" + scroll_x);
		} else {
